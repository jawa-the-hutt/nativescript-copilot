(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports,require('vue-property-decorator'),require('tns-core-modules/platform'),require('tns-core-modules/application'),require('nativescript-tweenjs'),require('tns-core-modules/ui/builder')):typeof define==='function'&&define.amd?define(['exports','vue-property-decorator','tns-core-modules/platform','tns-core-modules/application','nativescript-tweenjs','tns-core-modules/ui/builder'],f):(g=g||self,f(g.NativescriptVueCopilot={},g.vuePropertyDecorator,g.platform,g.application,g.nativescriptTweenjs,g.builder));}(this,function(exports, vuePropertyDecorator, platform, app, nativescriptTweenjs, builder){'use strict';/*! *****************************************************************************
