...
let ViewMask = class ViewMask extends Vue {
    constructor() {
        super(...arguments);
        this.points = {
            left: 0,
...
let ViewMask$2 = class ViewMask extends Vue {
    ...
    animate(animationDuration, position, size) {
        const safeAreaTop = isAndroid ? 0 : this.computedSafeArea.top;
...
let CopilotModal = class CopilotModal extends Vue {
    constructor() {
        super(...arguments);
        this.tooltip = {
            left: 0,
    ...
    getDeviceInfoAndroid() {
        const metrics = android.context.getResources().getDisplayMetrics();
        this.screenScale = metrics.density;
        const config = android.context.getResources().getConfiguration();
        this.layout = {
    ...
    async animateMove(view, verticalOffset) {
        ...
        const obj = {
            ...
            top: ((pos.y - (isAndroid ? this.safeArea.top : 0)) - (OFFSET_WIDTH / 2)) + verticalOffset
        };
        const objCenter = {
        ...
        if (verticalPosition === 'bottom') {
            tooltip.top = ((obj.top + obj.height) - (isAndroid ? 0 : this.safeArea.top)) + MARGIN;
            arrow.location = 'top';
